...
export default class Footer extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if(prevProps.isSoundActive != this.props.isSoundActive) {
            if(!this.props.isSoundActive) {
                this.nyanAudio.volume = 0
            } else {
                this.nyanAudio.volume = 0.4
            }
        }
    ...
    shareFacebook(e) {
        ...
        this.props.shareFacebook('images/synerg-baby-placeholder.png')
    }
            ...
            <footer className="main-footer">
                ...
                <div className="misc">
                    <div className="misc--buttons">
                        ...
                        <a
                            href="https://twitter.com/intent/tweet?text=Les%20enfants%20du%20web%20ont%20désormais%20un%20site%20!&url=https%3A%2F%2Fenfantsduweb.wtf%2F"
                            className="btn primary"
                            target="_blank">
